...
[![GoDoc](https://godoc.org/github.com/vbisbest/goproxy?status.svg)](https://godoc.org/github.com/vbisbest/goproxy)
[![Join the chat at https://gitter.im/vbisbest/goproxy](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/vbisbest/goproxy?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
![Status](https://github.com/vbisbest/goproxy/workflows/Go/badge.svg)
...
Get the latest goproxy from `gopkg.in/vbisbest/goproxy.v1`.
...
[the eavesdropper example](https://github.com/vbisbest/goproxy/blob/master/examples/goproxy-eavesdropper/main.go#L27)
2. Transparent proxy support for http/https including MITM certificate generation for TLS.  See the [transparent example.](https://github.com/vbisbest/goproxy/tree/master/examples/goproxy-transparent)
